...
var JoyStick = (function(container, parameters, callback) {
    ...
    function drawExternal() {
        ...
        // 創建逕向漸變
        var gradient = context.createRadialGradient(centerX, centerY, internalRadius-5, centerX, centerY, internalRadius+5 );
        ...
        drawArrow(centerX *1.5, centerY, centerX *1.58, centerY); // 右箭頭
    }
